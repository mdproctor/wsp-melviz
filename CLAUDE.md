...
- `@casehubio/pages-primitives` — Lit-dependent UI primitives: a11y mixins (LiveRegionMixin, FocusTrapMixin, RovingTabindexMixin, KeyboardShortcutMixin), modal dialog (`PagesModal`). Depends on `lit`. Migrated from blocks-ui-core in blocks-ui#48.
